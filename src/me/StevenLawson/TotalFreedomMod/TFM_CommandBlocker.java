...
public class TFM_CommandBlocker
{
    ...
    public static final void load()
    {
        ...
        for (String rawEntry : blockedCommands)
        {
            ...
            if (rank == null || action == null || command == null || command.isEmpty())
            {
                TFM_Log.warning("Invalid command blocker entry: " + rawEntry);
                continue;
            }
            ...
            if (commandParts.length > 1)
            {
                ...
                subCommand = StringUtils.join(commandParts, " ", 1, commandParts.length);
            }
            ...
            {
                TFM_Log.info("Blocking unknown command: " + command);
            }
            else
            {
            ...
            final CommandBlockerEntry blockedCommandEntry = new CommandBlockerEntry(rank, action, command, subCommand, message);
    ...
    public static boolean isCommandBlocked(String command, CommandSender sender, boolean doAction)
    {
        ...
        {
            if (subCommand == null || !subCommand.equals(entry.getSubCommand()))
            {
                return false;
            }
        }
    ...
    public static class CommandBlockerEntry
    {
        ...
        private CommandBlockerEntry(CommandBlockerRank rank, CommandBlockerAction action, String command, String subCommand, String message)
        {
            ...
            this.subCommand = subCommand.toLowerCase().trim();
